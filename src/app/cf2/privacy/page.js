    ...
    <div className={styles.frame}>
      <div className={styles.body} style={{ padding: '60px 20px 40px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', background: 'rgba(255, 255, 255, 0.9)', padding: '30px', borderRadius: '8px' }}>
          <h1 style={{ textAlign: 'center', marginBottom: '30px', color: '#333' }}>Política de Privacidade</h1>
          
          <div style={{ color: '#333', lineHeight: '1.6' }}>
            <p>Última atualização: 26 de Fevereiro de 2025</p>
            
            <p>A sua privacidade é importante para nós. É política do Willtrader respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Willtrader, e outros sites que possuímos e operamos.</p>
            ...
            <h2 style={{ marginTop: '30px', marginBottom: '15px' }}>Publicidade</h2>
            ...
            <h2 style={{ marginTop: '30px', marginBottom: '15px' }}>Compromisso do Usuário</h2>
            
            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Willtrader oferece no site e com caráter enunciativo, mas não limitativo:</p>
            ...
            <ol style={{ marginLeft: '20px', marginTop: '10px', marginBottom: '10px' }}>
              ...
              <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Willtrader, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
            </ol>
            
            <h2 style={{ marginTop: '30px', marginBottom: '15px' }}>Mais informações</h2>
